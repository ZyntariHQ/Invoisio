...
export const CONTRACT_ERROR_MANIFEST = [
  ...
  },
  {
    ...
    name: 'InvalidAsset',
    meaning:
      'token code was empty, exceeded 12 characters, or was the reserved code "XLM" on Asset::Token; native XLM must use Asset::Native. Token issuers are Address values, so a malformed issuer cannot reach this error.',
  },
  {
    code: 8,
  ...
  },
  {
    ...
    meaning: 'rebuild_history_index() failed to rebuild the payment history index; check storage consistency.',
  },
  {
    code: 18,
    name: 'MigrationRequired',
    meaning:
      'rebuild_history_index() was called on a deployment whose storage schema is not yet current; run upgrade_storage() first.',
  },
  {
    code: 19,
