#!/usr/bin/env bash
#
# Unpause the Invoisio Soroban contract
#
# Usage: ./invoke-unpause.sh
#
...
#
# This calls the contract's set_paused(false) method.
...
echo ""
echo "🚀 Invoking set_paused(false)..."
echo ""
...
echo ""
echo "✅ Contract unpaused successfully!"
echo ""
